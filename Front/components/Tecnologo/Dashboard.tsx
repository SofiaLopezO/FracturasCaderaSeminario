...
// RoleGuard is a page-level wrapper so we don't import it here
...
// Ensure we import only what's needed for the dashboard
...
function LabExamsPanel() {
    ...
    const examenesFiltrados = useMemo(() => {
        ...
        return examenes.filter((ex) => {
            ...
            const byMuestra =
                !filtros.tipoMuestra ||
                ex.muestras?.some((m) => m.tipo_muestra === filtros.tipoMuestra);
            const byQ =
                !q ||
...
export default function TecnologoDashboard() {
